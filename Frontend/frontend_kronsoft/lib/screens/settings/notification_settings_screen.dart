        ...
        children: [
                      ...
                      Expanded(
                        child: Column(
                          ...
                          children: [
                            ...
                            Text(
                              '$_pillReminderMinutes minutes before scheduled time',
                              style: TextStyle(
          ...
          GlassCard(
            child: _ToggleRow(
              ...
              subtitle: 'Daily exercise session reminders',
            ...
            child: Column(
              children: [
                _ToggleRow(
                  ...
                  label: 'Scan Alerts',
                  subtitle: 'Notifications about scan results and updates',
                  value: _scanAlerts,
                  onChanged: (v) {
                ...
                _ToggleRow(
                  ...
                  label: 'Daily Summary',
                  subtitle: 'Receive a daily health summary at 9 PM',
                  value: _dailySummary,
                  onChanged: (v) {
                ...
                _ToggleRow(
                  ...
                  label: 'Weekly Report',
                  subtitle: 'Get a weekly health progress report',
                  value: _weeklyReport,
                  onChanged: (v) {
          ...
          GlassCard(
            ...
            child: Row(
              children: [
                ...
                Expanded(
                  child: Text(
                    'Notifications use Firebase Cloud Messaging. Make sure notifications are enabled in your device settings.',
                    style: TextStyle(
                      color: context.appColors.textSecondary,
                      fontSize: 13,
                      height: 1.4,
